    ...
    <div class="Movies1">
        <figure>
            ...
            <figcaption>
                ...
                <ul>
                    <li style="color: white"><span class="SmallHeading">Director - </span>Simon McQuiod</li>
                    <li style="color: white"><span class="SmallHeading">Stars - </span>Lewis Tan, Jessica McNamee, Josh Lawson </li>
                    <li style="color: white">MMA fighter Cole Young seeks out Earth's greatest
        ...
        <figure>
            ...
            <figcaption>
                ...
                <ul>
                    <li style="color: white"><span class="SmallHeading">Director - </span>Florian Zeller</li>
                    <li style="color: white"><span class="SmallHeading">Stars - </span>Anthony Hopkins, Olivia Colman, Mark Gatiss </li>
                    <li style="color: white">A man refuses all assistance from his daughter as he ages.
        ...
        <figure>
            ...
            <figcaption>
                ...
                <ul>
                    <li style="color: white"><span class="SmallHeading">Director - </span>Lee Isaac Chung</li>
                    <li style="color: white"><span class="SmallHeading">Stars - </span>Steven Yeun, Yeri Han, Alan S. Kim</li>
                    <li style="color: white">A Korean family starts a farm in 1980s Arkansas. </li>
                </ul>
            </figcaption>
        </figure>
    </div>
        ...
        <div class="Movies2">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <ul>
                        <li style="color: white"><span class="SmallHeading">Director - </span>Andy Serkis</li>
                        <li style="color: white"><span class="SmallHeading">Stars - </span>Tom Hardy, Michelle Williams, Stephen Graham</li>
                        <li style="color: white">Sequel to the 2018 film 'Venom'. </li>
                        <li style="color: white"><span class="SmallHeading">Release Date- </span> 24 September 2021</li>
                    </ul>
                </figcaption>
            </figure>
            <figure>
                ...
                <figcaption>
                    ...
                    <ul>
                        <li style="color: white"><span class="SmallHeading">Director - </span>James Gunn</li>
                        <li style="color: white"><span class="SmallHeading">Stars - </span>Margot Robbie, Idris Elba, John Cena</li>
                        <li style="color: white">Supervillains Harley Quinn, Bloodsport,
                        ...
                        <li style="color: white"><span class="SmallHeading">Release Date- </span> 06 August 2021</li>
                    </ul>
                </figcaption>
            </figure>
            <figure>
                ...
                <figcaption>
                    ...
                    <ul>
                        <li style="color: white"><span class="SmallHeading">Director - </span>Jaume Collet-Serra</li>
                        <li style="color: white"><span class="SmallHeading">Stars - </span>JDwayne Johnson, Emily Blunt, Edgar Ramírez</li>
                        <li style="color: white">Based on Disneyland's theme park ride where a small riverboat takes
                            a group of travelers through a jungle filled with
                            dangerous animals and reptiles but with a supernatural element.</li>
                        <li style="color: white"><span class="SmallHeading">Release Date- </span> 30 July 2021</li>
                    </ul>
                </figcaption>
            </figure>
        </div>
